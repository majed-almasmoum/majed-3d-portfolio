...
const put = await fetch(url, { method: ‘PUT’, headers: hdrs, body: JSON.stringify({ message: `Delete: ${id}`, content: Buffer.from(JSON.stringify(updated, null, 2)).toString(‘base64’), sha: d.sha }) });
